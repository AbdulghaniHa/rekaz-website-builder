    ...
    <div className="bg-white border-t border-gray-200 px-2 py-2 safe-area-bottom mobile-no-select">
      <div className="flex items-center justify-around">
        {tabConfig.map((tab) => {
          ...
          // Special badge logic
          const showBadge = tab.id === "hierarchy" && state.sections.length > 0;
          ...
          return (
            <motion.button
              ...
              className={`relative flex flex-col items-center justify-center p-2 rounded-xl transition-all duration-200 min-w-[60px] mobile-tap-target ${
                isActive
